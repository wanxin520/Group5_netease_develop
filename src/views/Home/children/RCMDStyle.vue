...
<template>
  ...
  <div class="w-[100vw] flex justify-center items-center">
    ...
    >
      <van-swipe-item
        class="p-2"
        v-for="(item, index) in props.data.creatives"
        :key="item.id"
      >
        <div class="flex flex-col items-center">
          ...
          >
            <van-swipe-item
              @click="getResourceId(inItem.resourceExtInfo.songData.id)"
            ...
            >
              <div class="h-[100%] flex justify-center items-start">
                <div class="h-[100%] flex justify-center items-center">
                  <img
                    class="rounded-[20px] w-[4rem] p-1"
                    :src="inItem.uiElement.image.imageUrl"
                    alt=""
                  />
                </div>
                <div
                  class="w-[80%] h-[100%] p-3 flex flex-col justify-center items-start"
                >
                  <div
                  ...
                  <div
                    class="h-[1rem] m-1 flex justify-start items-center text-[#3f3f3f] text-[8px]"
                  >
                    <!-- 歌手姓名 -->
                    <span>{{
                  ...
                  <div class="flex p-1 justify-start items-center">
                    <div
                      v-if="
                        inItem.resourceExtInfo.songData.fee == 1 ||
                        inItem.resourceExtInfo.songData.fee == 8
                      "
                    ...
                    <div
                      v-else-if="inItem.resourceExtInfo.songData.sqMusic"
                      style="border: 1px, solid #f8d7d7"
                      class="h-[0.9rem] flex justify-center p-1 items-center rounded-[6px] text-[#ff2f2f] text-[8px]"
                    >
                      <span>SQ</span>
                    ...
                    <div
                      v-if="inItem.uiElement.subTitle"
