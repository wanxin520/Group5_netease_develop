...
<template>
    ...
    <div v-else-if="props.eventType == 19">
        ...
        <div class="w-[100%] text-[10px] p-1 overflow-hidden whitespace-nowrap">{{ eventDetail.msg }}</div>
        <div class="w-[100%] h-[3.5rem] flex justify-start items-center bg-[#f0f0f0] rounded-[10px] mt-2 p-1">
    ...
    <div v-else-if="props.eventType == 35 || props.eventType == 13">
        ...
        <div class="text-[10px] overflow-hidden whitespace-normal p-1">{{ eventDetail.msg }}</div>
        <div v-if="eventDetail.playlist"
            class="w-[100%] h-[3.5rem] flex justify-start items-center bg-[#f0f0f0] rounded-[10px] mt-2 p-1">
