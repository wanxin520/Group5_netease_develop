...
<template>
    <div>
        ...
        <van-sticky>
            <div class="w-[100%] h-[8vh] flex justify-between items-center "
                ...
                <div class=" h-[5vh] flex justify-between items-center">
                    <Icon class="ml-2" icon="icon-park-solid:play" width="1.2rem" height="1.2rem"
                        style="color: #ff0000" />
        ...
        <div v-for="(item, index) in props.tracks" :key="item.al.id"
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex flex-col overflow-hidden">
                    ...
                    <div class="flex h-[2vh] my-2">
                        ...
                        <!-- 专辑名称 --><!-- 歌手名称 -->
                        <div
                            class="w-[12rem] text-[8px]  text-[#828793]  overflow-hidden text-ellipsis whitespace-nowrap">
            ...
            <div class="flex justify-center items-center text-[#8d8d8d] text-[18px]">
                <Icon v-if="(item.mv != 0)" icon="fluent:video-clip-16-regular" class="mr-5" />
